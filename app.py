...
lineaccesstoken = 'OnF9Pmaj7WzJPC2jVUiOb+27KXdXH6kuRHZhYiETtRo3S55a04FDaq4VM6D6wjkOFqIL3EbkAcxkKq745PjikQKCjgQWaIX04+kH8CzignTTGecHBPg6lfs81LvPPAJa3A/1izow5R3Rv8THCa5u6gdB04t89/1O/w1cDnyilFU='
...
def event_handle(event):
    ...
    if msgType == "text":
        ...
        if (msg == "สวัสดี") :
            ...
            replyObj = TextSendMessage(text="เป็นรูกแงว")
        elif (msg == "txt") : 
            replyObj = TextSendMessage(text="เพลงดีมาก")
        elif (msg == "วินวินจะกลับ127เมื่อไหร่") : 
            replyObj = TextSendMessage(text="ถามหมานจ้า")         
        if (msg == "เบอ1เจน4วงอะไร") :
            replyObj = TextSendMessage(text="ทูมอโร่บายทูเกเต้อ!")
        else :
